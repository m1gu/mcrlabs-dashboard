#!/usr/bin/env python
"""Command-line entry point to synchronise QBench orders."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Synchronise QBench orders")
    parser.add_argument(
        "--full",
        action="store_true",
...
def main() -> None:
    ...
    logging.info("Starting order sync (full_refresh=%s)", args.full)
